...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        let modelURL = Bundle.main.url(forResource: "Products", withExtension: "momd")!
    ...
    lazy var persistanceStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let URLPersistanceStore = applicationDocumentDirectory.appendingPathComponent("Products.sqlite")
